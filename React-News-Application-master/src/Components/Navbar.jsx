      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <div className="dropdown" style={{ position: 'relative', marginLeft: 'auto' }}>
            ...
            >
              <li><div className="dropdown-item" onClick={() => setUpCountry('za')}>South Africa</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('us')}>United States</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('gb')}>United Kingdom</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('de')}>Germany</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('fr')}>France</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('au')}>Australia</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('in')}>India</div></li>
              <li><div className="dropdown-item" onClick={() => setUpCountry('jp')}>Japan</div></li>
            </ul>
          </div>
        </div>
      </div>
